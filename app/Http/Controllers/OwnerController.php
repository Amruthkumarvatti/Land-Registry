...
class OwnerController extends Controller
{
    ...
    {
        // Permanently remove owner including soft-deleted records
        // delete any uploaded files first
        if ($owner->photo) {
            \Illuminate\Support\Facades\Storage::disk('public')->delete($owner->photo);
        }
        if ($owner->id_document) {
            \Illuminate\Support\Facades\Storage::disk('public')->delete($owner->id_document);
        }
