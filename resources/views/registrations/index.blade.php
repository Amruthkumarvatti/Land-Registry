                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            ...
                            @endif
                            @if(in_array($reg->status, ['pending', 'rejected']) && auth()->user()->isRegistrar())
                            ...
                            @endif
                            <form action="{{ route('registrations.destroy', $reg) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this registration?')">
                                @csrf
                                @method('DELETE')
