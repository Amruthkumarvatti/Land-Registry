                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            ...
                            @if(in_array($t->status, ['pending', 'rejected']) && auth()->user()->isRegistrar())
                            ...
                            <form action="{{ route('transfers.destroy', $t) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this transfer?')">
                                @csrf
                                @method('DELETE')
