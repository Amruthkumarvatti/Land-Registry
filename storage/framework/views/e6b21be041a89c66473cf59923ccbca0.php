            ...
            <?php $__empty_1 = true; $__currentLoopData = $registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="small">
                        ...
                        <?php else: ?>
                            <span class="text-muted">Property missing</span>
                        <?php endif; ?>
                    </td>
                    <td class="small">
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            ...
                            <?php endif; ?>
                            <?php if(in_array($reg->status, ['pending', 'rejected']) && auth()->user()->isRegistrar()): ?>
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('registrations.destroy', $reg)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Delete this registration?')">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="btn btn-xs btn-outline-danger" title="Delete" style="padding:2px 7px;font-size:.75rem;"><i class="bi bi-trash"></i></button>
                            </form>
                        </div>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\V Amruth Kumar\Desktop\MVC\land-registry\resources\views/registrations/index.blade.php ENDPATH**/ ?>