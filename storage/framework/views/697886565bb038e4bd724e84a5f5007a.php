                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            ...
                            <?php if(in_array($t->status, ['pending', 'rejected']) && auth()->user()->isRegistrar()): ?>
                            ...
                            <form action="<?php echo e(route('transfers.destroy', $t)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Delete this transfer?')">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="btn btn-xs btn-outline-danger" style="padding:2px 7px;font-size:.75rem;" title="Delete"><i class="bi bi-trash"></i></button>
                            </form>
                            <?php endif; ?>
                        </div>
                    </td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\V Amruth Kumar\Desktop\MVC\land-registry\resources\views/transfers/index.blade.php ENDPATH**/ ?>