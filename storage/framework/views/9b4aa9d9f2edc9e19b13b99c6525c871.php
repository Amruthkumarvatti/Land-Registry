    ...
    <div class="login-card">
        ...
        <?php if($errors->any()): ?>
            <div class="alert alert-danger py-2">
                <small><?php echo e($errors->first()); ?></small>
            </div>
        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('email')); ?>" placeholder="your@email.gov" required autofocus>
                </div>
            </div>
            <div class="mb-3">
...
<?php /**PATH C:\Users\V Amruth Kumar\Desktop\MVC\land-registry\resources\views/auth/login.blade.php ENDPATH**/ ?>