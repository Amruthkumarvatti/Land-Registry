...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('reports.pdf', 'registrations')); ?>" class="btn btn-sm btn-outline-danger">
            <i class="bi bi-file-pdf me-1"></i>Registrations PDF
        </a>
        <a href="<?php echo e(route('reports.pdf', 'properties')); ?>" class="btn btn-sm btn-outline-danger">
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $stats['properties_by_type']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e(ucfirst($row->land_type)); ?></td>
                            <td><span class="badge bg-primary"><?php echo e($row->count); ?></span></td>
                            <td><?php echo e(number_format($row->total_area, 0)); ?></td>
                            <td class="fw-500">₹<?php echo e(number_format($row->total_value, 0)); ?></td>
                        </tr>
...
<div class="row g-3">
    <div class="col-md-4">
        <div class="card p-3">
            ...
            <a href="<?php echo e(route('reports.registrations')); ?>" class="btn btn-sm btn-outline-primary">View Report</a>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card p-3">
            ...
            <a href="<?php echo e(route('reports.properties')); ?>" class="btn btn-sm btn-outline-primary">View Report</a>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card p-3">
            ...
            <a href="<?php echo e(route('reports.owners')); ?>" class="btn btn-sm btn-outline-primary">View Report</a>
        </div>
    </div>
</div>
...
new Chart(dCtx, {
    type: 'bar',
    data: {
        labels: <?php echo json_encode($stats['top_districts']->pluck('district')); ?>,
        datasets: [{
            label: 'Properties',
            data: <?php echo json_encode($stats['top_districts']->pluck('count')); ?>,
...
new Chart(rCtx, {
    type: 'line',
    data: {
        labels: <?php echo json_encode($stats['registrations_by_month']->pluck('month')); ?>,
        datasets: [{
            label: 'Revenue (₹)',
            data: <?php echo json_encode($stats['registrations_by_month']->pluck('revenue')); ?>,
            borderColor: '#3b82f6',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\V Amruth Kumar\Desktop\MVC\land-registry\resources\views/reports/index.blade.php ENDPATH**/ ?>